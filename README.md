...
https://github.com/Window**ploits/Exploits 微软 CVE-2012-0217、CVE-2016-3309、CVE-2016-3371、CVE-2016-7255、CVE-2017-0213 提权利用
...
https://github.com/Arno0x/DN**filtrator 利用 DNS 解析进行数据隐秘传输的工具
https://github.com/ytisf/PyExfil 用于数据取回的 Python 软件包
https://github.com/Arno0x/ReflectiveDn**filtrator 反射 DNS 解析隐蔽通道进行数据泄露
